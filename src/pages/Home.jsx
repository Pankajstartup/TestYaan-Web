  ...
  useEffect(() => {
    ...
    fetch(sheetUrl).then(res => res.text()).then(csv => {
      Papa.parse(csv, { header: true, complete: (res) => {
          ...
          setDisplayPackages(pkgs.slice(0, 6)); // Top 6 packages dikhane ke liye
      }});
    });
  }, []);
      ...
      <section style={heroStyle}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={searchBoxStyle}>
            <input type="text" placeholder="Search for Health Packages..." style={inputStyle} />
...
// --- STYLES (Keep in Original Format) ---
